...
public class DatosAux {
    ...
    public static void setNombre(String nombre) {
        DatosAux.nombre = nombre;
    }

    public static void setImagenUri(Uri imagenUri) {
        DatosAux.imagenUri = imagenUri;
    }

    public static void setAlineamiento(String alineamiento) {
        DatosAux.alineamiento = alineamiento;
    }

    //METODOS GENERICOS: formatear datos de la api
